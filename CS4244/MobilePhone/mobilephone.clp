...
(deffacts init-phone-facts
  ...
  (phone (model X7)(price 430.00)
         (brand nokia)(color black)(screen 4)(weight 149.0)(memory 32)
         (os symbian)(fm no)
         (zoom 2)(pixel 8)(flash yes)(videoHD yes))  
  ; HTC
  (phone (model Chacha)(price 280.00)
         (brand htc)(color black)(screen 2.6)(weight 120.0)(memory 32)
         (os android)(bluetooth yes)(fm yes)
	     (zoom 0)(pixel 5)(flash yes)(videoHD yes))
  ...
  (phone (model rhyme)(price 550.00)
         (brand htc)(color black)(screen 3.7)(weight 130)(memory 32)
         (os android)
  ...
  (phone (model galaxy_ace)(price 310.00)
         ...
         (os android)(fm yes)
	     (pixel 5)(flash yes)(videoHD yes))
  (phone (model galaxy nexus)(price 805.00)
  ...
  (phone (model galaxy_tab_7.0_plus)(price 650.00)
         (brand samsung)(color black)(screen 7)(weight 345.0)(memory 32)
         (os android)(fm no)
  ...
  (phone (model omnia_w)(price 465.00)
         (brand samsung)(screen 3.7)(weight 115)(memory 8)
         (os windows)(fm yes)
         (pixel 5)(flash yes))			 
  ; LG
  ...
  ;	      (zoom 3)(pixel 1)(flash yes)(videoHD yes))
)
